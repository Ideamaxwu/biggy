...
public class egD3PipeJobVisual {
	public void startVisualPage(BigData bigdata) throws IOException {
		new fileBD(bigdata.getBD()).egVisualFile("src\\main\\java\\com\\helpal\\datar\\rbiggy\\examples\\PageRank\\res\\pagerank_data.js", "com.helpal.datar.rbiggy.examples.PageRank.egPageRankD3PipeJobVisualTask001");
		bigdata.Show();
		...
		if (osName.indexOf("Linux") != -1) {
			...
			Runtime.getRuntime().exec("explorer src\\main\\java\\com\\helpal\\datar\\rbiggy\\examples\\PageRank\\res\\pagerank.html");
